...
def train_model():
	model_filename = "{0}-{1}-{2}_lstm_model".format(date.month, date.day, date.year)
	...
	model.compile(loss='binary_crossentropy', optimizer='adam', metrics=[f1, metrics.binary_accuracy])
	model.fit_generator(
